...
const MyProjectsPHPVanilla: React.FC = () => (
  ...
  >
    <MyProjectBaseBody>
      ...
      <p>
        Possui autenticação, cadastro e logout. Utilizando <a href={'https://mdbootstrap.com'}>Material Design Bootstrap 5</a> no frontend,
        foi criado um sistema de cadastro de dívidas como exemplo de uso das funcionalidades que o MVC possui.
      </p>

      <p>
        Após realizar o cadastro/login no sistema, no menu lateral possui uma opção para acessar o menu <b>Minhas dívidas</b> para listagem,
        criação, edição e exclusão de dívidas do usuário autenticado.
      </p>
